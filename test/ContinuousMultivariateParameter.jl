...
llf(states, i) =
  ...
  -0.5*(
    (states[2].value-states[i].value)'*inv(states[3].value)*(states[2].value-states[i].value)+
    μvlen*log(2*pi)+
...
lpf(states, i) =
  states[i].logprior =
  -0.5*(
    (states[i].value-states[4].value)'*inv(states[5].value)*(states[i].value-states[4].value)+
    μvlen*log(2*pi)+
...
p = ContinuousMultivariateParameter(
  1,
  :p,
  logtarget=(states, i) -> states[i].logtarget = -(states[i].value-states[2].value)⋅(states[1].value-states[2].value)
)
...
gllf(states, i) = states[1].gradloglikelihood = (states[3].value\(states[2].value-states[1].value))
...
gllf(states, i) = states[i].gradloglikelihood = (states[3].value\(states[2].value-states[i].value))

glpf(states, i) = states[i].gradlogprior = -(states[5].value\(states[i].value-states[4].value))

...
GenericModel(vs::Vector{Variable}, ds::Vector{Dependence}; is_directed::Bool=true) =
  graph(vs, ds, is_directed=is_directed)

GenericModel(is_directed::Bool=true) = graph(Variable[], Dependence[], is_directed=is_directed)
